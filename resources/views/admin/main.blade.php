    ...
    <div class="grid-system">
        ...
        <div class="horz-grid">
            <div class="grid-hor">
                ...
                <p class="">Using a single set of <code>.col-md-*</code> grid classes,
                    ...
                    before becoming horizontal on desktop (medium) devices. Place grid columns in any <code>.row</code>.
                </p>
            </div>
            <!---->
        ...
        <div class="horz-grid">
            <div class="grid-hor">
                ...
                <p>Don't want your columns to simply stack in smaller devices? Use the extra small
                    and medium device grid classes by adding <code>.col-xs-*</code> <code>.col-md-*</code> to your
                    columns. See the example below for
        ...
        <div class="horz-grid">
            ...
            <div class="row show-grid">
                ...
                <div class="col-xs-4">.col-xs-4<br>Since 9 + 4 = 13 &gt; 12, this 4-column-wide div gets wrapped onto a
        ...
        <div class="horz-grid">
            <div class="grid-hor">
                ...
                <p>Move columns to the right using <code>.col-md-offset-*</code> classes. These classes increase the
                    left margin of a column by <code>*</code> columns. For example, <code>.col-md-offset-4</code> moves
        ...
        <div class="horz-grid">
            <div class="grid-hor">
                ...
                <p>To nest your content with the default grid, add a new <code>.row</code> and set of
                    <code>.col-sm-*</code>
                    columns within an existing <code>.col-sm-*</code> column. Nested rows should include a set of
                    columns that add up to 12 or fewer
